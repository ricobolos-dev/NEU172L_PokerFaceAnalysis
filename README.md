...
### MATLAB Scripts (`scripts/matlab/`)
- `step1_preprocessing.m` - EEG preprocessing
- `step2a_decoding.m` - Neural decoding analysis
- `step2b_markovchain.m` - Behavioral predictability analysis
- `setup_toolboxes.m` - MATLAB setup and verification
- `RUN_ALL_ANALYSIS.m` - Master script to run complete pipeline
- `TEST_ONE_SUBJECT.m` - Quick test script for single pair
...
- `nsaf101 (1).pdf` - Original research paper
- `NEU172L final project assignment.pdf` - Assignment description
...
│       └── TEST_ONE_SUBJECT.m          # Quick test script
│
├── docs/                               # Documentation
│   ├── READY_TO_RUN.md                 # Quick start guide
│   ├── QUICKSTART.md                   # Fast overview
│   ├── RUN_MATLAB_ANALYSIS.md          # MATLAB instructions
│   ├── ANALYSIS_GUIDE.md               # Python analysis guide
│   ├── DATASET_GUIDE.md                # Dataset documentation
│   └── GITHUB_SETUP.md                 # GitHub setup
│
├── references/                         # Reference materials
│   ├── FinalProposal.pdf               # Project proposal
│   ├── nsaf101 (1).pdf                 # Original paper
│   └── NEU172L final project...pdf    # Assignment
│
├── results/                            # Analysis outputs
│   └── poker_face_correlation.png      # Main result figure
│
